  ...
  return (
    <div>
      ...
      <div className="px-3 py-6">
        <h2 className="font-montserrat font-semibold text-xl mb-2">Accessibility & Closed Captioning Policy</h2>
        ...
        <h2 className="font-montserrat font-semibold text-xl mb-4">Closed Captioning (CC) Policy</h2>
        <p className="font-montserrat text-sm mb-4">
        ...
        <h2 className="font-montserrat font-semibold text-xl mb-4">User Responsibilities</h2>
        <p className="font-montserrat text-sm mb-4">
        ...
        <h2 className="font-montserrat font-semibold text-xl mb-4">Policy Updates</h2>
        <p className="font-montserrat text-sm mb-4">
        ...
        <p className="font-montserrat text-sm mb-4">Effective Date: May 25, 2024</p>
      </div>
    </div>
  );
}
