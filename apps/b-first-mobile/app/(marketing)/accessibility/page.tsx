  ...
  return (
    <>
      ...
      <div className="px-3 py-6 font-montserrat">
        <h1 className="font-semibold text-2xl mb-4 text-center">Accessibility & Closed Captioning Policy</h1>
        ...
        <h2 className="font-semibold text-xl mb-4">Closed Captioning (CC) Policy</h2>
        <p className="text-sm mb-4">
        ...
        <h2 className="font-semibold text-xl mb-4">Reporting Accessibility Issues</h2>
        <p className="text-sm mb-4">
        ...
        <h2 className="font-semibold text-xl mb-4">User Responsibilities</h2>
        <p className="text-sm mb-4">
        ...
        <h2 className="font-semibold text-xl mb-4">Policy Updates</h2>
        <p className="text-sm mb-4">
