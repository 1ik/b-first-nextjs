      ...
      <div className="px-3 py-6 font-montserrat">
        ...
        <ul className="list-decimal pl-4">
          <li className="text-base mb-2">
            <span className="font-semibold">Acceptance of Terms</span> <br /> By accessing and using the Bangladesh
          ...
          <li className="text-base mb-2">
            <span className="font-semibold">Use of Content</span> <br />
          ...
          <ul className="list-disc mb-2 pl-6">
            <li className="text-base mb-2">Use the Website for any unlawful purpose.</li>
            <li className="text-base mb-2">
