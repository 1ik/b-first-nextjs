  ...
  return (
    <div>
      ...
      <div className="px-3 py-6">
        <h2 className="font-montserrat font-semibold text-xl mb-2">Cookie Settings Policy</h2>
        <h2 className="font-montserrat font-semibold text-xl mb-4">Introduction</h2>
        ...
        <h2 className="font-montserrat font-semibold text-xl mb-2">What are Cookies?</h2>
        <p className="font-montserrat text-sm mb-4">
        ...
        <h2 className="font-montserrat font-semibold text-xl mb-4">Types of Cookies We Use</h2>

        <h2 className="font-montserrat text-xl mb-2">We use the following types of cookies on our Website:</h2>
        ...
        <h2 className="font-montserrat font-semibold text-xl mb-4"> Third-Party Cookies</h2>
        ...
        <h2 className="font-montserrat font-semibold text-xl mb-4">Managing Your Cookie Preferences</h2>
        <p className="font-montserrat text-sm mb-4">
        ...
        <ul className="list-disc pl-4">
          ...
          <li className="font-montserrat text-base mb-2">Block third-party cookies.</li>
          <li className="font-montserrat text-base mb-2">Block cookies from specific websites.</li>
          <li className="font-montserrat text-base mb-2">Block all cookies from being set.</li>
        </ul>
      </div>
    </div>
  );
