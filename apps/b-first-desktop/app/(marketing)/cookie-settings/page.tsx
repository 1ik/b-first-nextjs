...
export const metadata = {
  title: "Cookie Settings Policy | Bangladesh First",
};
...
export default function CookieSettings() {
  return (
    <>
      <Navbar />
      <div className="desktop-container pt-8 pb-24 font-montserrat">
        <h1 className="font-semibold text-3xl mb-6 text-center">Cookie Settings Policy</h1>
