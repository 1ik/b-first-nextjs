...
export const metadata = {
  title: "Comment Policy | Bangladesh First",
};
  ...
  return (
    <>
      ...
      <div className="desktop-container pt-16 pb-24 font-montserrat">
        <h1 className="font-semibold text-xl md:text-4xl text-center mb-8">Comment Policy</h1>
        ...
        <ul className="list-decimal pl-6 md:pl-16">
          <li className="font-medium text-base  mb-4 pl-5">
