  ...
  return (
    <>
      ...
      <div className="desktop-container pt-16 pb-24 font-montserrat">
        <h2 className="font-semibold text-xl md:text-4xl  mb-6 text-center">Privacy Policy</h2>
        ...
        <h3 className="font-bold text-lg md:text-2xl  mb-6">Information We Collect :</h3>
        ...
        <p className="font-medium text-base  mb-4">
          <span className=" font-semibold md:font-bold text-lg md:text-xl">Usage Data :</span> We automatically collect
        ...
        <h3 className="font-bold text-lg md:text-2xl  mb-8">How We Use Your Information:</h3>
        ...
        <h3 className="font-bold text-lg md:text-2xl  mb-4">Information Sharing and Disclosure :</h3>
