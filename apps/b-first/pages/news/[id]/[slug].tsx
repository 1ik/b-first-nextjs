...
export function Index({ news, categoryNews, latestNews, featured }: any) {
  return (
    <>
      <Head>
        <script type='text/javascript' src='https://platform-api.sharethis.com/js/sharethis.js#property=65bf1f0a2bb34700194aa4e2&product=inline-share-buttons' async='async'></script><script type='text/javascript' src='https://platform-api.sharethis.com/js/sharethis.js#property=65bf1f0a2bb34700194aa4e2&product=inline-share-buttons' async='async'></script>
      </Head>
      <Header />
      <MobileMenu />
      <main id="content">
                ...
                <div className="flex-shrink max-w-full w-full lg:w-2/3 overflow-hidden pr-6">
                  ...
                  <div className="news-meta border-1 border-b mb-4 pb-3">
                    <div className="flex justify-between">
                      ...
                      <div className="sharethis-inline-share-buttons pb-2"></div>
                    </div>
