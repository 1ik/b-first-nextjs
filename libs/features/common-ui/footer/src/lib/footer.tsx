    ...
    <div className="font-montserrat py-20 text-white">
      ...
      <ul className="flex font-semibold items-center justify-center">
        {links.map((link, index) => (
          <li
            key={index}
            className={`relative before:content-[''] before:absolute before:h-2/5 before:w-[2px] before:bg-white before:right-0 before:top-1/2 before:-translate-y-1/2 after:content-[''] after:absolute after:h-[3px]
              
             after:left-1/2 after:bottom-0 after:-translate-x-1/2 after:bg-white hover:after:w-1/3 z after:duration-300`}
          >
