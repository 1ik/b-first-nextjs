...
export function BlockNews5({ data, sectionHeader, headerColor, className, ads1, ads2 }: BlockNews5Props) {
  return (
    <div className={className}>
      ...
      <div className="grid grid-cols-4">
        <div className="border-r dark:border-dark-300 mr-4 pr-4">
          {data?.slice(4, 11).map((item: any, index: number) => (
            <div className="flex flex-col" key={index}>
              <ItemCardHorizontal key={index} className="last:mb-0" size="md" data={item} titleFontSize="16px" />
        ...
        <div className="col-span-3 grid grid-cols-3 gap-5">
          <ItemCardVertical className="col-span-2" data={data?.[0]} size="lg" titleBold />
